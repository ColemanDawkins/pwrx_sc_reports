...
CREATE TABLE IF NOT EXISTS dari_motion (
    ...
    dp7_grf_max         NUMERIC,
    dp7_net_impulse     NUMERIC,
    dp7_rfd             NUMERIC,
    dp9_squat_depth     NUMERIC,
    dp11_jump_height    NUMERIC,
    dp11_grf_max        NUMERIC,
    uploaded_at         TIMESTAMPTZ DEFAULT NOW()
);
...
COLUMN_ALIASES = {
    ...
    # dari
    "session_guid": ["meta__session__session_guid", "session_guid", "sessionGuid"],
    "session_ts":   ["timestamp", "session_ts", "sessionTs", "date"],
    "score_overall":["summary__scores__athleticism__overall", "score_overall", "overall"],
    ...
    "score_dysfunction":["summary__scores__dysfunction", "score_dysfunction", "dysfunction"],
    ...
    "dp7_jump_height":["datapoints__7__0__jump_height", "dp7_jump_height"],
    "dp7_grf_max":  ["datapoints__7__0__grf_max", "dp7_grf_max"],
    # armcare
...
TABLE_COLUMNS = {
    ...
    "dari_motion": [
        "master_uid", "dari_id", "session_guid", "first_name", "last_name",
        "session_ts", "score_overall", "score_function", "score_explosive",
        ...
        "dp9_squat_depth", "dp11_jump_height", "dp11_grf_max",
    ],
    "armcare": [
